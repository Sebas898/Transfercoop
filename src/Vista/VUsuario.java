...
public class VUsuario extends JFrame {
	...
	public VUsuario() {
		...
		btnTrasferir_1 = new JLabel("");
		btnTrasferir_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnTrasferir_1.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnTb.png")));
				contentPane.updateUI();
			}
			
			@Override
			public void mouseExited(MouseEvent e) {
				btnTrasferir_1.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnTa.png")));
				contentPane.updateUI();
			}
		});
		btnTrasferir_1.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnTa.png")));
		btnTrasferir_1.setBounds(214, 309, 150, 39);
		panelT.add(btnTrasferir_1);
		...
		panelP.setBackground(new Color(0, 128, 128, 0));
		...
		btnTrasferir.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnTa.png")));
		btnTrasferir.setBounds(218, 275, 150, 39);
		...
		btnRetirar.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnRa.png")));
		btnRetirar.setBounds(32, 275, 150, 39);
		panelP.add(btnRetirar);
		...
		btnMovimientos.setIcon(new ImageIcon(VUsuario.class.getResource("/Vista/img/btnMa.png")));
		btnMovimientos.setBounds(398, 275, 150, 39);
